...
var $gateSize, $halfGateSize, $openConnection, $socketPadding, $socketSize, AndGate, BufferGate, Collectable, Device, Gate, IODevice, Lightbulb, NandGate, NorGate, NotGate, OrGate, Socket, Switch, Tool, Toolbox, Wire, XnorGate, XorGate, distance, distanceSquared, startBoolex, stopBoolex,
...
Gate = (function(_super) {
  ...
  Gate.inputs = function() {
    return $.grep(Socket.all, function(socket) {
      return socket.type === 'in' && !socket.connectedToGate();
    });
  };
...
Switch = (function(_super) {
  ...
  function Switch() {
    ...
    this.graphics.on('click', function() {
      ...
      return $(window).trigger('update', [true, self.outSocket]);
    });
  }
